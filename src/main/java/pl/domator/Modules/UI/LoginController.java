...
public class LoginController {
    ...
    public void openDBConfig() {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/pl/domator/fxml/Core/DBConfig.fxml"));
    ...
    private Stage showUpdateDialog() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/pl/domator/fxml/Core/UpdateDialog.fxml"));
            Scene scene = new Scene(loader.load());
